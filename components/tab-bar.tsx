...
export default function TabBar() {
  ...
  return (
    <div className="fixed bottom-0 w-full mx-auto max-w-screen-sm grid grid-cols-5 border-neutral-600 border-t px-5 py-3">
      ...
      <Link href="/chats" className="flex flex-col items-center gap-px">
        {pathname === '/chats' ? <SolidChatIcon className="w-7 h-7" /> : <OutlineChatIcon className="w-7 h-7" />}
        <span>채팅</span>
      </Link>
